...
-- -- tabla antes de insertar los nuevos valores. --revisar
DELIMITER //
...
-- bucle REPEAT (210secuenciaRepeat). --revisar
DELIMITER //
...
-- bucle LOOP (211secuenciaLoop). -revisar
DELIMITER //
CREATE or replace PROCEDURE 211secuenciaLoop(IN tope INT UNSIGNED)
BEGIN	
  DECLARE contador INT;
  TRUNCATE TABLE 28par;
  TRUNCATE TABLE 28impar;
